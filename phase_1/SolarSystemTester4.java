...
public class SolarSystemTester4{
    ...
    public static void main(String[] args) {
        ...
        System.out.println(mars.getPositionsArray().get(0));
        System.out.println(mars.getPositionsArray().get(marsposition));
        ...
        System.out.println("Error on the X Coordinate = " + (Math.abs((mars.getPositionsArray().get(0).getX()) - mars.getPositionsArray().get(marsposition).getX()) / (mars.getPositionsArray().get(0).getX())) * 100 + " %");
        System.out.println("Error on the Y Coordinate = " + (Math.abs((mars.getPositionsArray().get(0).getY()) - mars.getPositionsArray().get(marsposition).getY()) / (mars.getPositionsArray().get(0).getY())) * 100 + " %");
        System.out.println("Error on the Z Coordinate = " + (Math.abs((mars.getPositionsArray().get(0).getZ()) - mars.getPositionsArray().get(marsposition).getZ()) / (mars.getPositionsArray().get(0).getZ())) * 100 + " %");
    }
}